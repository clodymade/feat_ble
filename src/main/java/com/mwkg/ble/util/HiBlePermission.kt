 ...
 */
internal object HiBlePermission {
     ...
     * ```
     */
    fun getMergedPermissions(vararg types: HiBlePermissionType): Array<String> {
 ...
 */
internal enum class HiBlePermissionType {
 ...
 */
internal object HiBlePermissionReqCodes {
